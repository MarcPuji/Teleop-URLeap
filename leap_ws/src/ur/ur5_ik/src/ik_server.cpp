...
bool srvURIK(ur5ik::UR5IK::Request &req, ur5ik::UR5IK::Response &res)
{
    ...
    UR5::Configuration _theta_ref = {req.theta_ref[0], req.theta_ref[1], req.theta_ref[2],
                                     req.theta_ref[3], req.theta_ref[4], req.theta_ref[5]};
    UR5::Configuration _theta_min = {req.theta_min[0], req.theta_min[1], req.theta_min[2],
                                     req.theta_min[3], req.theta_min[4], req.theta_min[5]};
    UR5::Configuration _theta_max = {req.theta_max[0], req.theta_max[1], req.theta_max[2],
